...
<li class="pc-item"><a href="{{ route('user.hasil_pengumuman') }}" class="pc-link"><span class="pc-micon"><i
                class="ti ti-speakerphone"></i></span><span class="pc-mtext">Hasil Pengumuman</span></a></li>
