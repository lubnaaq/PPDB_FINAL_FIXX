                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <table style="width: 100%; border: none;">
                                <tr style="border: none;">
                                    ...
                                    <td style="border: none; text-align: center; padding-left: 20px;">
                                        ...
                                        <h3 style="margin: 5px 0; font-size: 10pt; font-weight: bold;">SURAT PEMBERITAHUAN DAFTAR ULANG</h3>
                        ...
                        <div class="print-info">
                            ...
                            <table style="border: none; width: auto; margin: 0 auto 20px auto;">
                                 <tr style="border: none;">
                                    ...
                                    <td style="border: none; padding: 3px 0;">421.5/DU/{{ str_pad(Auth::user()->id, 4, '0', STR_PAD_LEFT) }}/{{ date('Y') }}</td>
                                </tr>
                                <tr style="border: none;">
                             ...
                             <p style="margin: 20px 0 10px 0; text-align: justify; font-size: 11pt; line-height: 1.6;">
                                Berdasarkan hasil seleksi Penerimaan Peserta Didik Baru (PPDB), kami sampaikan kepada calon peserta didik berikut:
                            </p>
                            ...
                            <table style="border: none; width: 100%; margin: 10px 0 20px 20px;">
                             ...
                             <p style="margin: 20px 0 10px 0; text-align: justify; font-size: 11pt; line-height: 1.6;">
                                Diwajibkan untuk melakukan <strong>DAFTAR ULANG</strong> dengan rincian jadwal sebagai berikut:
                            </p>

                            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                                <thead style="background-color: #f0f0f0;">
                                    <tr>
                                        <th style="border: 1px solid #333; padding: 8px; text-align: center;">Kegiatan</th>
                                        <th style="border: 1px solid #333; padding: 8px; text-align: center;">Tanggal</th>
                                        <th style="border: 1px solid #333; padding: 8px; text-align: center;">Waktu</th>
                                        <th style="border: 1px solid #333; padding: 8px; text-align: center;">Tempat</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style="border: 1px solid #333; padding: 8px;">Daftar Ulang Gelombang 1</td>
                                        <td style="border: 1px solid #333; padding: 8px; text-align: center;">10 - 12 Juli {{ date('Y') }}</td>
                                        <td style="border: 1px solid #333; padding: 8px; text-align: center;">08.00 - 14.00 WIB</td>
                                        <td style="border: 1px solid #333; padding: 8px; text-align: center;">Ruang Tata Usaha</td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid #333; padding: 8px;">Daftar Ulang Gelombang 2</td>
                                        <td style="border: 1px solid #333; padding: 8px; text-align: center;">15 - 17 Juli {{ date('Y') }}</td>
                                        <td style="border: 1px solid #333; padding: 8px; text-align: center;">08.00 - 14.00 WIB</td>
                                        <td style="border: 1px solid #333; padding: 8px; text-align: center;">Ruang Tata Usaha</td>
                                    </tr>
                                </tbody>
                            ...
                            <p style="margin: 15px 0 5px 0; font-weight: bold; font-size: 11pt;">Berkas yang wajib dibawa:</p>
                        ...
                        <div class="print-footer">
                            ...
                            <p style="margin: 2px 0 0 0; font-size: 8pt;">Harap membawa dokumen ini saat melakukan daftar ulang.</p>
                        </div>
                        </div>
