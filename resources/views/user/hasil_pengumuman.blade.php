                    ...
                    <div class="card-body">
                        <div class="screen-only">
                            ...
                            @if ($status_kelulusan == 'LULUS')
                                ...
                                <p class="lead">
                                    Selamat <strong>{{ Auth::user()->name }}</strong>, Anda telah dinyatakan
                                    <strong>LULUS</strong> seleksi penerimaan siswa baru di SMK Kami.
                                </p>

                                @if (isset($biodata) && $biodata->kelas)
                                    <div class="card bg-light border-success mb-3 d-inline-block px-4">
                                        <div class="card-body py-2">
                                            <h5 class="card-title text-success mb-0">Diterima di Kelas:
                                                {{ $biodata->kelas->nama_kelas }}</h5>
                                            <small class="text-muted">{{ $biodata->jurusan->nama ?? '' }}</small>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="alert alert-success mt-4" role="alert">
                                    ...
                                    <p>Silakan melakukan <strong>Daftar Ulang</strong> pada menu yang tersedia atau klik
                            ...
                            @elseif ($status_kelulusan == 'TIDAK LULUS')
                                ...
                                <p class="lead">
                                    Mohon maaf <strong>{{ Auth::user()->name }}</strong>, Anda dinyatakan <strong>TIDAK
                                        LULUS</strong> dalam seleksi penerimaan siswa baru tahun ini.
                                </p>
                                <p class="text-muted">
                        ...
                        <div class="print-container" style="display: none;">
                                    ...
                                    <tr style="border: none;">
                                        ...
                                        <td style="border: none; text-align: center; padding-left: 20px;">
                                            <h2 style="margin: 0; font-size: 18pt; font-weight: bold;">SMK ANTARTIKA 1
                                                SIDOARJO</h2>
                                            <h3 style="margin: 5px 0; font-size: 10pt; font-weight: bold;">SURAT KETERANGAN
                                                LULUS SELEKSI PENERIMAAN SISWA BARU</h3>
                            ...
                            <div class="print-info">
                                ...
                                <table style="border: none; width: auto; margin: 0 auto 20px auto;">
                                    <tr style="border: none;">
                                        ...
                                        <td style="border: none; padding: 3px 0;">
                                            421.5/{{ str_pad(Auth::user()->id, 4, '0', STR_PAD_LEFT) }}/PPDB/{{ date('Y') }}
                                        </td>
                                    </tr>
                                    <tr style="border: none;">
                                ...
                                <p style="margin: 20px 0 10px 0; text-align: justify; font-size: 11pt; line-height: 1.6;">
                                    Berdasarkan hasil seleksi Penerimaan Peserta Didik Baru (PPDB) SMK Antartika 1 Sidoarjo
                                    Tahun Ajaran {{ date('Y') }}/{{ date('Y') + 1 }}, dengan ini Kepala Sekolah
                                    menerangkan bahwa:
                                </p>
                                ...
                                <table style="border: none; width: 100%; margin: 20px 0 20px 20px;">
                                    ...
                                    <tr style="border: none;">
                                        ...
                                        <td style="border: none; padding: 5px 0;">:</td>
                                        <td style="border: none; padding: 5px 0;">
                                            {{ Auth::user()->biodata->asal_sekolah ?? '-' }}</td>
                                    </tr>
                                    <tr style="border: none;">
                                ...
                                <p style="margin: 20px 0 10px 0; text-align: justify; font-size: 11pt; line-height: 1.6;">
                                    Berdasarkan hasil rapat Pleno Panitia PPDB pada tanggal
                                    {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}, peserta didik dengan data
                                    tersebut di atas dinyatakan:
                                </p>

                                <div style="text-align: center; margin: 30px 0;">
                                    <span
                                        style="border: 3px double #000; padding: 10px 40px; font-size: 24pt; font-weight: bold; letter-spacing: 5px;">
                                        @if ($status_kelulusan == 'LULUS')
                                            LULUS
                                        @elseif($status_kelulusan == 'TIDAK LULUS')
                                            TIDAK LULUS
                                ...
                                <p style="margin: 20px 0 10px 0; text-align: justify; font-size: 11pt; line-height: 1.6;">
                                    Demikian surat keterangan ini dibuat untuk dapat dipergunakan sebagaimana mestinya. Bagi
                                    peserta didik yang dinyatakan lulus dimohon untuk segera melakukan daftar ulang sesuai
                                ...
                                <table class="signature-table" style="border: none; width: 100%; margin-top: 50px;">
                                    <tr style="border: none;">
                                        ...
                                        <td style="width: 50%; border: none; text-align: center; vertical-align: top;">
                                            ...
                                            <p style="margin: 5px 0 0 0; font-weight: bold; font-size: 11pt;">Kepala
                                                Sekolah</p>
                            ...
                            <div class="print-footer">
                                ...
                                <p style="margin: 2px 0 0 0; font-size: 8pt;">Halaman ini merupakan dokumen resmi dan sah.
                                    Validasi dokumen dapat dilakukan dengan menghubungi panitia PPDB.</p>
                            </div>
                        </div>
                    </div>
