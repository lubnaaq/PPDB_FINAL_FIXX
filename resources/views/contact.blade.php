...
@section('content')
    ...
    <header class="contact-hero"
        style="position: relative; padding: 100px 0; background: url('{{ asset('https://file.data.kemendikdasmen.go.id/sekolahkita/20/2050/20501717-4.jpg') }}') no-repeat center center; background-size: cover;">
